...
hl.window_rule({ match = { class = "com.github.rafostar.Clapper" }, no_blur = true })
hl.window_rule({ match = { class = "com.github.rafostar.Clapper" }, opacity = 1 })
hl.window_rule({ match = { class = "google-chrome.*" }, opacity = 1 })
hl.window_rule({ match = { class = "google-chrome.*" }, no_blur = true })
hl.window_rule({ match = { class = "Fin.*" }, opacity = 1 })
hl.window_rule({ match = { class = "Fin.*" }, no_blur = true })
hl.window_rule({ match = { class = "steam.*" }, opacity = 1 })
...
hl.window_rule({ match = { class = "Waydroid" }, opacity = 1 })
hl.window_rule({ match = { class = "Waydroid" }, no_blur = true })
...
hl.window_rule({ match = { class = "Evershot" }, fullscreen = true })
...
hl.layer_rule({ match = { namespace = "quickshell:.*" }, blur_popups = false})
hl.layer_rule({ match = { namespace = "quickshell:.*" }, blur = false})
hl.layer_rule({ match = { namespace = "quickshell:.*" }, ignore_alpha = 0.79})
hl.layer_rule({ match = { namespace = "quickshell:bar" }, animation = "slide", blur = true})
...
hl.layer_rule({ match = { namespace = "quickshell:sidebarLeft" }, blur_popups = true})
hl.layer_rule({ match = { namespace = "quickshell:sidebarLeft" }, ignore_alpha = 0.2})
