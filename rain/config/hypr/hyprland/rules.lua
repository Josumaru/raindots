...
-- Quickshell (namespace = quickshell:<panelName>)
hl.layer_rule({ match = { namespace = "quickshell:.*" }, blur_popups = true})
hl.layer_rule({ match = { namespace = "quickshell:.*" }, blur = true})
hl.layer_rule({ match = { namespace = "quickshell:.*" }, ignore_alpha = 0.79})
hl.layer_rule({ match = { namespace = "quickshell:bar" }, animation = "slide"})
hl.layer_rule({ match = { namespace = "quickshell:bar" }, xray = false})
hl.layer_rule({ match = { namespace = "quickshell:barBackground" }, animation = "slide"})
...
hl.layer_rule({ match = { namespace = "quickshell:notificationPopup" }, blur_popups = true})
hl.layer_rule({ match = { namespace = "quickshell:notificationPopup" }, ignore_alpha = 0.2})
...
hl.layer_rule({ match = { namespace = "quickshell:sidebarRight" }, blur_popups = true})
hl.layer_rule({ match = { namespace = "quickshell:sidebarRight" }, ignore_alpha = 0.2})
