...
hl.window_rule({match = {title = "wallpaper-picker" }, no_blur = true })

hl.window_rule({ match = { class = ".*" }, opacity = 0.8 })
hl.window_rule({ match = { class = "code" }, opacity = 0.8 })
hl.window_rule({ match = { class = "google-chrome" }, opacity = 1 })
hl.window_rule({ match = { title = "Picture in picture" }, opacity = 1 })
hl.window_rule({ match = { class = "Emulator" }, opacity = 1 })
hl.window_rule({ match = { class = "Evershot" }, opacity = 1 })
hl.window_rule({ match = { class = "Evershot" }, center = true, float = true, size = {"(monitor_w*1.0)", "(monitor_h*1.0)"}})


-- Floating
hl.window_rule({match = {title = "^(Open File)(.*)$" },                      center = true})
hl.window_rule({match = {title = "wallpaper-picker" },                       float = true})
hl.window_rule({match = {title = "wallpaper-picker" },                       center = true})
hl.window_rule({match = {title = "wallpaper-picker" },                       opacity = 1})
...
-- Quickshell (namespace = rain:<panelName>)
hl.layer_rule({ match = { namespace = "rain:.*" }, blur_popups = true})
hl.layer_rule({ match = { namespace = "rain:.*" }, blur = true})
hl.layer_rule({ match = { namespace = "rain:.*" }, ignore_alpha = 0.79})
hl.layer_rule({ match = { namespace = "rain:bar" }, animation = "slide"})
hl.layer_rule({ match = { namespace = "rain:actionCenter" }, no_anim = true})
hl.layer_rule({ match = { namespace = "rain:cheatsheet" }, animation = "slide bottom"})
hl.layer_rule({ match = { namespace = "rain:dock" }, animation = "slide bottom"})
hl.layer_rule({ match = { namespace = "rain:screenCorners" }, animation = "popin 120%"})
hl.layer_rule({ match = { namespace = "rain:lockWindowPusher" }, no_anim = true})
hl.layer_rule({ match = { namespace = "rain:notificationPopup" }, animation = "fade"})
hl.layer_rule({ match = { namespace = "rain:overlay" }, no_anim = true})
hl.layer_rule({ match = { namespace = "rain:overlay" }, ignore_alpha = 1})
hl.layer_rule({ match = { namespace = "rain:overview" }, no_anim = true})
hl.layer_rule({ match = { namespace = "rain:osk" }, animation = "slide bottom"})
hl.layer_rule({ match = { namespace = "rain:polkit" }, no_anim = true})
hl.layer_rule({ match = { namespace = "rain:popup" }, xray = false})
hl.layer_rule({ match = { namespace = "rain:popup" }, ignore_alpha = 1})
hl.layer_rule({ match = { namespace = "rain:mediaControls" }, ignore_alpha = 1})
hl.layer_rule({ match = { namespace = "rain:reloadPopup" }, animation = "slide"})
hl.layer_rule({ match = { namespace = "rain:regionSelector" }, no_anim = true})
hl.layer_rule({ match = { namespace = "rain:screenshot" }, no_anim = true})
hl.layer_rule({ match = { namespace = "rain:session" }, blur = true})
hl.layer_rule({ match = { namespace = "rain:session" }, no_anim = true})
hl.layer_rule({ match = { namespace = "rain:session" }, ignore_alpha = 0})
hl.layer_rule({ match = { namespace = "rain:sidebarRight" }, animation = "slide right"})
hl.layer_rule({ match = { namespace = "rain:sidebarLeft" }, animation = "slide left"})
hl.layer_rule({ match = { namespace = "rain:osk" }, order = -1})
