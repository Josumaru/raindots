...
hl.bind("SUPER + SUPER_R", hl.dsp.exec_cmd("pgrep -f 'quickshell -c rain' || pkill fuzzel || fuzzel"))
...
hl.bind("SUPER_R", hl.dsp.global("quickshell:workspaceNumber"),
    { ignore_mods = true, transparent = true, release = true })
hl.bind("SUPER + Tab", hl.dsp.exec_cmd(rainBin .. " ipc overview toggle"), { description = "Shell: Toggle overview" })
hl.bind("SUPER + V", hl.dsp.exec_cmd(rainBin .. " ipc overview clipboardToggle"))
hl.bind("SUPER + Period", hl.dsp.exec_cmd(rainBin .. " ipc overview emojiToggle"))
hl.bind("SUPER + A", hl.dsp.exec_cmd(rainBin .. " ipc sidebarLeft toggle"), { description = "Shell: Toggle left sidebar" })
hl.bind("SUPER + ALT + A", hl.dsp.exec_cmd(rainBin .. " ipc sidebarLeft toggleDetach"))
hl.bind("SUPER + B", hl.dsp.exec_cmd(rainBin .. " ipc sidebarLeft toggle"))
hl.bind("SUPER + O", hl.dsp.exec_cmd(rainBin .. " ipc sidebarLeft toggle"))
hl.bind("SUPER + N", hl.dsp.exec_cmd(rainBin .. " ipc sidebarRight toggle"), { description = "Shell: Toggle right sidebar" })
hl.bind("SUPER + Slash", hl.dsp.exec_cmd(rainBin .. " ipc cheatsheet toggle"), { description = "Shell: Toggle cheatsheet" })
hl.bind("SUPER + K", hl.dsp.exec_cmd(rainBin .. " ipc osk toggle"), { description = "Shell: Toggle on-screen keyboard" })
hl.bind("SUPER + M", hl.dsp.exec_cmd(rainBin .. " ipc mediaControls toggle"), { description = "Shell: Toggle media controls" })
hl.bind("SUPER + G", hl.dsp.exec_cmd(rainBin .. " ipc overlay toggle"), { description = "Shell: Toggle widget overlay" })
hl.bind("CTRL + ALT + Delete", hl.dsp.exec_cmd(rainBin .. " ipc session toggle"), { description = "Shell: Toggle session menu" })
hl.bind("SUPER + J", hl.dsp.exec_cmd(rainBin .. " ipc bar toggle"), { description = "Shell: Toggle bar" })
hl.bind("SHIFT + SUPER + ALT + Slash", hl.dsp.exec_cmd(rainBin .. " shell welcome"))
...
hl.bind("CTRL + SUPER + T", hl.dsp.exec_cmd(rainBin .. " ipc wallpaperSelector toggle"),
    { description = "Shell: Change wallpaper" })
hl.bind("CTRL + SUPER + ALT + T", hl.dsp.exec_cmd(rainBin .. " ipc wallpaperSelector random"),
    { description = "Shell: Random wallpaper" })
hl.bind("CTRL + SUPER + W", hl.dsp.exec_cmd(rainBin .. " ipc wallpaperPicker toggle"),
    { description = "Shell: Wallpaper picker" })
hl.bind("CTRL + SUPER + SHIFT + D", hl.dsp.exec_cmd(rainBin .. " ipc toggleLightDark toggle"),
    { description = "Shell: Toggle light/dark mode" })
hl.bind("CTRL + SUPER + R", hl.dsp.exec_cmd(rainBin .. " shell kill; " .. rainBin .. " shell &"),
    { description = "Shell: Restart widgets" })

--##! Utilities
--# Screenshot, Record, OCR, Color picker, Clipboard history
hl.bind("SUPER + V", hl.dsp.exec_cmd(
        "pgrep -f 'quickshell -c rain'" .. " || pkill fuzzel || cliphist list | fuzzel --match-mode fzf --dmenu | cliphist decode | wl-copy"),
...
--##! Session
hl.bind("SUPER + L", hl.dsp.exec_cmd(rainBin .. " lock"), { description = "Session: Lock" })
...
hl.bind("SUPER + R", hl.dsp.exec_cmd(vicinae))
