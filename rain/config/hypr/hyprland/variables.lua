...
function rainIpc(module, func)
    local args = rainBin .. " ipc " .. module .. " " .. (func or "toggle")
    return hl.dsp.exec_cmd(args)
end

-- Apps
-- PULL REQUESTS ADDING MORE WILL NOT BE ACCEPTED, CONFIG FOR YOURSELF
terminal = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'terax' 'warp-terminal' 'foot' 'kitty -1' 'alacritty' 'wezterm' 'konsole' 'kgx' 'uxterm' 'xterm'"
