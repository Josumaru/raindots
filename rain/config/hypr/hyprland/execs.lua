hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("$rainBin/rain shell")
    ...
    -- Clipboard
    hl.exec_cmd("wl-paste --type text --watch bash -c 'cliphist store && $rainBin/rain ipc cliphistService update'")
    hl.exec_cmd("wl-paste --type image --watch bash -c 'cliphist store && $rainBin/rain ipc cliphistService update'")
