...
// progress wave meter: full-width dim line, ember crest lit from the left to `frac`.
Item {
    id: root
    ...
    Canvas {
        ...
        Timer {
            interval: 40; running: root.visible; repeat: true
            onTriggered: { canvas.phase = (canvas.phase + 0.09) % 6.28318; canvas.requestPaint(); }
        }
