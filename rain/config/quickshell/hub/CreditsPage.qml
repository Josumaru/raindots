...
// Credits = a showcase "thank you" screen.
Item {
    id: page
        ...
        Column {
            ...
            Column {
                ...
                Text {
                    ...
                    text: "Raindots stands on the work of others. These projects, communities, and "
                        + "people lent code, ideas, and a sharp eye."
                    color: Theme.subtle
    ...
    component SectionHead: Column {
        ...
        Row {
            spacing: 8
            Rectangle {
                width: 5; height: 5; radius: Theme.radius; color: Theme.brand
                anchors.verticalCenter: parent.verticalCenter
            }
            Text {
                text: sh.text
    ...
    component CreditLine: Item {
        ...
        Rectangle {
            ...
            height: 1; color: hov.hovered ? Theme.line : Theme.lineSoft
            Behavior on color { ColorAnimation { duration: Theme.quick } }
        }
    }
    ...
    component TesterChip: Item {
        ...
        property string url: ""
        width: chipRow.width + 26; height: 50
        ...
        Rectangle {
            ...
            border.width: 1; border.color: thov.hovered ? Theme.lineStrong : Theme.line
            Behavior on color { ColorAnimation { duration: Theme.quick } }
        ...
        Row {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    font.family: Theme.font; font.pixelSize: 13; font.weight: Font.Black
                }
            }
            Column {
                ...
                Text {
                    text: "BUG HUNTER"
                    color: Theme.dim; font.family: Theme.mono; font.pixelSize: 8
