...
// rain hub hypr backend (settings.lua applied via hyprctl eval).
Item {
    id: page
    ...
    Process {
        id: layoutsProc
        command: [Directories.rainBin, "hub", "hypr", "layouts"]
        running: true
    ...
    Process {
        ...
        command: [Directories.rainBin, "hub", "hypr", "variants", forLayout]
        stdout: StdioCollector {
            onStreamFinished: {
