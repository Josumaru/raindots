...
// global results, shown whenever the sidebar search has a query.
Flickable {
    id: page
        ...
        Column {
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Text {
                        anchors.left: secIcon.right; anchors.leftMargin: 13
                        anchors.verticalCenter: parent.verticalCenter
                        text: modelData.name
        ...
        Item {
            ...
            Column {
                ...
                Icon {
                    ...
                    name: "search"; size: 32; weight: 1.5; tint: Theme.faint
                }
                Text {
                    anchors.horizontalCenter: parent.horizontalCenter
                    text: "Nothing matches"
                    color: Theme.subtle; font.family: Theme.font
