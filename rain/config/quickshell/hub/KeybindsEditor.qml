...
// Custom keybinds editor: user shortcuts layered over the shipped binds.
Item {
    id: page
    ...
    Text {
        ...
        text: "Custom shortcuts layered over the ones Raindots ships. Write the combo the way Hyprland does, e.g. SUPER + J or SUPER + SHIFT + Return."
        color: Theme.dim
    ...
    HubButton {
        id: addBtn
        anchors.left: parent.left; anchors.top: intro.bottom; anchors.topMargin: 14
        label: "Add shortcut"; icon: "plus"
        onClicked: page.add()
    }
    ...
    Flickable {
        ...
        anchors.top: addBtn.bottom; anchors.topMargin: 16
        anchors.bottom: bar.top; anchors.bottomMargin: 16
                ...
                delegate: Rectangle {
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            border.width: 1; border.color: keysIn.activeFocus ? Theme.ember : Theme.line
                            ...
                            TextInput {
                                ...
                                color: Theme.bright; font.family: Theme.mono
                                ...
                                Text {
                                    ...
                                    text: "SUPER + J"; color: Theme.faint; font: keysIn.font
                                }
                            }
                        }
                        ...
                        Dropdown {
                            anchors.verticalCenter: parent.verticalCenter
                            width: 230; fieldWidth: 150; label: ""
                        ...
                        Rectangle {
                            ...
                            height: 32
                            radius: Theme.radius; visible: rowItem.needsValue; color: Theme.surface
                            border.width: 1; border.color: valIn.activeFocus ? Theme.ember : Theme.line
                            Behavior on border.color { ColorAnimation { duration: Theme.quick } }
                            TextInput {
                                id: valIn
                                anchors.fill: parent
                                ...
                                color: Theme.bright; font.family: Theme.mono; font.pixelSize: 13
                                clip: true; selectByMouse: true
                                onEditingFinished: page.patch(rowItem.index, "value", text)
                                Text {
                                    anchors.fill: parent; verticalAlignment: Text.AlignVCenter
                                    visible: valIn.text === "" && !valIn.activeFocus
                                    text: "command to run"; color: Theme.faint; font: valIn.font
                                }
                            }
                        }
                    }
                    ...
                    Item {
                        ...
                        width: 26; height: 26
                        Icon {
                            anchors.centerIn: parent; name: "trash"; size: 15
    ...
    Rectangle {
        ...
        height: 60; radius: Theme.radius
        color: store.dirty ? Qt.rgba(Theme.ember.r, Theme.ember.g, Theme.ember.b, 0.08) : Theme.surfaceLo
        border.width: 1; border.color: store.dirty ? Qt.rgba(Theme.ember.r, Theme.ember.g, Theme.ember.b, 0.4) : Theme.line
        ...
        Text {
            anchors.left: dot.right; anchors.leftMargin: 11; anchors.verticalCenter: parent.verticalCenter
        ...
        Row {
            ...
            spacing: 10
            HubButton { label: "Clear all"; icon: "refresh"; onClicked: store.editList("keybinds", []) }
            HubButton { label: "Revert"; icon: "close"; enabled: store.dirty; onClicked: store.revert() }
            HubButton { label: "Save"; icon: "check"; primary: true; enabled: store.dirty; onClicked: store.save() }
        }
    }
}
