...
Button {
    ...
    property real leftRadius: root.buttonRadius
    property real rightRadius: root.buttonRadius
    ...
    background: Rectangle {
        ...
        border.width: root.tabbedTo ? 2 : (root.hovered || root.toggled ? 1 : 0)
        border.color: root.toggled ? Appearance.colors.colPrimary : Appearance.m3colors.m3outline
