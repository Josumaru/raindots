...
Singleton {
    ...
    sizes: QtObject {
        ...
        property real notificationPopupWidth: 610
    ...
    // Warm-harmonized color palette (ryoku-arch inspired).
    // Takes the auto-generated M3 palette and warms it up for a cohesive,
    // intentional look. All colors are derived dynamically from the wallpaper
    // via m3colors, but shifted towards warm tones (vermillion accent, warm
    // dark surfaces, cream text) like the ryoku-arch reference.
    warm: QtObject {
        property color accent: root.m3colors.m3primary
        property color onAccent: root.m3colors.m3onPrimary
        property color accentHover: ColorUtils.mix(root.m3colors.m3primaryContainer, root.m3colors.m3primary, 0.7)
        property color accentActive: ColorUtils.mix(root.m3colors.m3primaryContainer, root.m3colors.m3primary, 0.5)
        property color bgBase: ColorUtils.mix(root.m3colors.m3background, "#1a120b", 0.5)
        property color bg: ColorUtils.transparentize(root.warm.bgBase, root.backgroundTransparency)
        property color bgSurface: ColorUtils.mix(root.m3colors.m3surfaceContainerLow, "#1a120b", 0.5)
        property color bgSurfaceLow: ColorUtils.mix(root.m3colors.m3surfaceContainer, "#1a120b", 0.5)
        property color bgSurfaceHigh: ColorUtils.mix(root.m3colors.m3surfaceContainerHigh, "#1a120b", 0.5)
        property color onSurface: ColorUtils.mix(root.m3colors.m3onSurface, "#e8dccc", 0.5)
        property color onSurfaceDim: ColorUtils.mix(root.m3colors.m3onSurfaceVariant, "#c7bfae", 0.5)
        property color onBg: ColorUtils.mix(root.m3colors.m3onBackground, "#e8dccc", 0.5)
        property color hairline: ColorUtils.transparentize(ColorUtils.mix(root.m3colors.m3outline, "#5c5249", 0.5), 0.5)
        property color hairlineHover: ColorUtils.mix(root.m3colors.m3outline, root.warm.accent, 0.5)
        property color outline: ColorUtils.mix(root.m3colors.m3outline, "#5c5249", 0.5)
    }
