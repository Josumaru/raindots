    ...
    component TitlebarButton: RippleButton {
        ...
        contentItem: Item {
            ...
            Icon {
                id: iconWidget
                size: 20
                name: titlebarButton.materialSymbol
                tint: titlebarButton.toggled ? Appearance.colors.colOnSecondaryContainer : Appearance.colors.colOnSurface
            }
        }
    }
}
