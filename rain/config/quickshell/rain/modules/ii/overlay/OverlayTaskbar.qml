...
Rectangle {
    ...
    component BatteryWidget: Row {
        ...
        Icon {
            ...
            name: Battery.isCharging ? "bolt" : "battery"
            tint: batteryWidget.colText
            size: 24
        }
    ...
    component WidgetButton: RippleButton {
        ...
        contentItem: Item {
            ...
            Icon {
                id: iconWidget
                size: 24
                name: widgetButton.materialSymbol
                tint: widgetButton.toggled ? Appearance.colors.colOnSecondaryContainer : Appearance.colors.colOnSurfaceVariant
            }
        }
    }
}
