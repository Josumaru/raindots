...
RowLayout {
    ...
    Icon {
        ...
        name: switch (root.searchPrefixType) {
            case SearchBar.SearchPrefixType.Action: return "sparkles";
            case SearchBar.SearchPrefixType.App: return "widgets";
            case SearchBar.SearchPrefixType.Clipboard: return "search";
            case SearchBar.SearchPrefixType.Emojis: return "sparkles";
            case SearchBar.SearchPrefixType.Math: return "search";
            case SearchBar.SearchPrefixType.ShellCommand: return "terminal";
            case SearchBar.SearchPrefixType.WebSearch: return "globe";
