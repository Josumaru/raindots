                ...
                TextCanvas { // Content translation
                    ...
                    GroupButton {
                        ...
                        contentItem: Icon {
                            ...
                            name: "check"
                            tint: copyButton.enabled ? Appearance.colors.colOnLayer1 : Appearance.colors.colSubtext
                        }
                        onClicked: {
                    ...
                    GroupButton {
                        ...
                        contentItem: Icon {
                            size: Appearance.font.pixelSize.larger
                            name: "globe"
                            tint: searchButton.enabled ? Appearance.colors.colOnLayer1 : Appearance.colors.colSubtext
                        }
                        onClicked: {
        ...
        TextCanvas { // Content input
            ...
            GroupButton {
                ...
                contentItem: Icon {
                    size: Appearance.font.pixelSize.larger
                    name: "folder"
                    tint: deleteButton.enabled ? Appearance.colors.colOnLayer1 : Appearance.colors.colSubtext
                }
                onClicked: {
