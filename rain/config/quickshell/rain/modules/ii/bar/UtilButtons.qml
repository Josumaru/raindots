    ...
    RowLayout {
        ...
        Loader {
            ...
            sourceComponent: CircleUtilButton {
                ...
                Icon {
                    name: Appearance.m3colors.darkmode ? "light_mode" : "dark_mode"
                    size: Appearance.font.pixelSize.large
                    tint: Appearance.colors.colOnLayer2
                }
            }
            ...
            sourceComponent: CircleUtilButton {
                ...
                Icon {
                    name: switch(PowerProfiles.profile) {
                        case PowerProfile.PowerSaver: return "bolt"
                        case PowerProfile.Balanced: return "chip"
                        case PowerProfile.Performance: return "rocket"
                    }
                    size: Appearance.font.pixelSize.large
                    tint: Appearance.colors.colOnLayer2
                }
